...
namespace assignment2
{
    public partial class AddInvoice : UserControl
    {
        ...
        private void customerCodeInput_TextChanged(object sender, EventArgs e)
        {
        ...
        private void calculateButton_Click(object sender, EventArgs e)
        {
            ...
            if (customerType == "Household customer")
            {
                if (numberOfPeople <= 0)
                {
                    MessageBox.Show("Please enter valid number people ");
                    return;
                }
            ...
            InvoiceManager.AddInvoice(customerCode, customerName, customerType,
                numberOfPeople, lastMonthNumber, thisMonthNumber, currentMonth, subTotal, envFee, VATFee, total);
        }
